    ...
    <div class="wrapper" >
        ...
        <header class="header">
            <nav class="head">
                ...
                <!-- Left Header -->
                <a href="/admin/manage" class="sidebar-header">
                ...
                <div class="search" id="search">
                    <form method="get" action="/admin/search"  class="">
            ...
            <div class="menu" id="menu_content">
                ...
                <a href="/admin/mostheart" class="menu-item">
                    <div >
                ...
                <a href="/admin/mostview" class="menu-item">
                    <div >
        ...
        <header class="header2">
            <nav class="head2">
                ...
                <!-- Left Header -->
                <a href="/admin/manage" class="sidebar-header2">
                    <ion-icon name="eye-off"></ion-icon>
                    <span>Anomus</span>
                </a>
            ...
            <div class="modal toggle" id="menu_content2">
                ...
                <a href="/admin/manage" class="menu-item2">
                    <div >
                ...
                <a href="/admin/mostheart" class="menu-item2">
                    <div >
                        <ion-icon name="heart-outline"></ion-icon>
                        <span>Lượt tim nhiều nhất</span>
                    </div>
                ...
                <a href="/admin/mostview" class="menu-item2">
                    <div >
                        <ion-icon name="bar-chart-outline"></ion-icon>
                        <span>Nhiều lượt xem</span>
                    </div>
